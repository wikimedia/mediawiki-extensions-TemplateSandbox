...
$messages['ca'] = array(
	...
	'templatesandbox-text' => "Podeu triar un conjunt de plantilles desades en el vostre espai de proves mitjançant l'ús d'un prefix de proves apropiat. Per exemple, si voleu previsualitzar una versió de {{ns:Template}}:Test que heu desat a «{{ns:User}}:Exemple/proves/{{ns:Template}}:Test», utilitzeu «{{ns:User}}:Exemple/proves» com a prefix.",
