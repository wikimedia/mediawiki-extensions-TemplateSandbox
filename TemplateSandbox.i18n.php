...
$messages['cy'] = array(
	...
	'templatesandbox-page-label' => "Cynhyrchu'r dudalen:",
	'templatesandbox-revid-label' => "Cynhyrchu'r diwygiad:",
	'templatesandbox-text-label' => "Cynhyrchu'r cystrawen wici:",
	...
	'templatesandbox-invalid-title' => 'Ysgrifennwyd teitl annilys.',
	'templatesandbox-title-not-exists' => "Nid yw'r teitl a enwyd ar gael.",
	'templatesandbox-revision-not-exists' => "Nid yw'r diwygiad a enwyd ar gael.",
);
 ...
 */
$messages['hi'] = array(
	'templatesandbox' => 'साँचा प्रयोगस्थल',
	'templatesandbox-desc' => 'एक प्रयोगस्थल से साँचे ट्रांसक्लूड कर के [[Special:TemplateSandbox|पृष्ठ रेंडर करता है]]।',
	'templatesandbox-suffix' => 'प्रयोगस्थल',
	'templatesandbox-legend' => 'साँचा प्रयोगस्थल',
	'templatesandbox-text' => 'आप उपयुक्त प्रयोगस्थल उपसर्ग चुन कर अपने प्रयोग स्थलों में सहेजे हुए साँचे चुन सकते हैं।
उदाहरण के तौर पे यदि आप आप {{ns:Template}}:Test का कोई अवतरण देखना चाहते हैं जो आपने "{{ns:User}}:Foo/{{int:templatesandbox-suffix}}/{{ns:Template}}:Test" नाम से सहेजा है तो उपसर्ग की जगह "{{ns:User}}:Foo/{{int:templatesandbox-suffix}}" का प्रयोग करें।',
	'templatesandbox-prefix-label' => 'प्रयोगस्थल उपसर्ग:',
	'templatesandbox-page-label' => 'रेंडर करने हेतु पृष्ठ:',
	'templatesandbox-revid-label' => 'रेंडर करने हेतु अवतरण:',
	'templatesandbox-text-label' => 'रेंडर करने हेतु विकिपाठ:',
	'templatesandbox-submit' => 'देखें',
	'templatesandbox-title-output' => 'साँचा प्रयोगस्थल: $1',
	'templatesandbox-editform-legend' => 'पृष्ठ की झलक इस साँचे के साथ देखें',
	'templatesandbox-editform-page-label' => 'पृष्ठ शीर्षक:',
	'templatesandbox-editform-view-label' => 'झलक दिखाएँ',
	'templatesandbox-preview' => '$2 की झलक',
	'templatesandbox-previewnote' => "'''ध्यान रखें कि यह केवल [[:$1]] की एक झलक है।'''
आपके बदलाव अभी सहेजे नहीं गए हैं!",
	'templatesandbox-invalid-title' => 'आपके द्वारा निर्दिष्ट शीर्षक अमान्य है।',
	'templatesandbox-title-not-exists' => 'आपके द्वारा निर्दिष्ट शीर्षक मौजूद नहीं है।',
	'templatesandbox-revision-not-exists' => 'आपके द्वारा निर्दिष्ट अवतरण मौजूद नहीं है।',
	'templatesandbox-invalid-prefix' => 'आपके द्वारा निर्दिष्ट प्रयोगस्थल उपसर्ग अमान्य है।',
	'templatesandbox-prefix-not-local' => 'आपके द्वारा निर्दिष्ट प्रयोगस्थल उपसर्ग स्थानीय नहीं है।',
	'templatesandbox-page-or-revid' => 'आपको पृष्ठ शीर्षक अथवा अवतरण आई॰डी संख्या प्रदान करनी होगी।',
	'templatesandbox-editform-need-title' => 'इस साँचे के साथ किसी अन्य पृष्ठ की झलक देखने के लिए पृष्ठ शीर्षक निर्दिष्ट करना अनिवार्य है।',
	'templatesandbox-editform-invalid-template' => 'आपके द्वारा निर्दिष्ट साँचा नाम अमान्य है।',
	'templatesandbox-editform-invalid-title' => 'झलक देखने हेतु आपके द्वारा निर्दिष्ट शीर्षक अमान्य है।',
	'templatesandbox-editform-title-not-exists' => 'झलक देखने हेतु आपके द्वारा निर्दिष्ट शीर्षक मौजूद नहीं है।',
);
 ...
 */
$messages['sl'] = array(
	'templatesandbox' => 'Peskovnik za predloge',
	'templatesandbox-desc' => '[[Special:TemplateSandbox|Prikaže stran]] z vključitvijo predlog iz peskovnika',
	'templatesandbox-suffix' => 'peskovnik',
	'templatesandbox-legend' => 'Peskovnik za predloge',
	'templatesandbox-text' => 'Z uporabo ustrezne predpone peskovnika lahko izberete množico predlog, ki ste jih shranili v svojem peskovniku.
Če želite npr. prikazati predogled različice {{ns:Template}}:Test, ki ste jo shranili kot  »{{ns:User}}:Foo/{{int:templatesandbox-suffix}}/{{ns:Template}}:Test«, uporabite predpono »{{ns:User}}:Foo/{{int:templatesandbox-suffix}}«.',
	'templatesandbox-prefix-label' => 'Predpona peskovnika:',
	'templatesandbox-page-label' => 'Prikazana stran:',
	'templatesandbox-revid-label' => 'Prikazana redakcija:',
	'templatesandbox-text-label' => 'Prikazano wikibesedilo:',
	'templatesandbox-submit' => 'Ogled',
	'templatesandbox-title-output' => 'Peskovnik za predloge: $1',
	'templatesandbox-editform-legend' => 'Predogled strani s to predlogo',
	'templatesandbox-editform-page-label' => 'Naslov strani:',
	'templatesandbox-editform-view-label' => 'Prikaži predogled',
	'templatesandbox-preview' => 'Predogled strani $2',
	'templatesandbox-previewnote' => "'''To je samo predogled strani [[:$1]].'''
Vaše spremembe še niso shranjene!",
	'templatesandbox-invalid-title' => 'Navedeni naslov ni veljaven.',
	'templatesandbox-title-not-exists' => 'Navedeni naslov ne obstaja.',
	'templatesandbox-revision-not-exists' => 'Navedena redakcija ne obstaja.',
	'templatesandbox-invalid-prefix' => 'Navedena predpona peskovnika ni veljavna.',
	'templatesandbox-prefix-not-local' => 'Navedena predpona peskovnika ni lokalna.',
	'templatesandbox-page-or-revid' => 'Navesti morate naslov strani ali ID-številko redakcije.',
	'templatesandbox-editform-need-template' => 'Za predogled še ene strani s to predlogo morate določiti ime predloge.',
	'templatesandbox-editform-need-title' => 'Za predogled druge strani s to predlogo morate navesti naslov strani.',
	'templatesandbox-editform-invalid-template' => 'Ime predloge, ki ste jo določili, ni veljavno.',
	'templatesandbox-editform-invalid-title' => 'Naslov, ki ste ga navedli za predogled, ni veljaven.',
	'templatesandbox-editform-title-not-exists' => 'Naslov, ki ste ga navedli za predogled, ne obstaja.',
);
...
$messages['zh-hans'] = array(
	...
	'templatesandbox-text' => '您可以通过使用合适的沙盒前缀选择一组已保存于您的沙盒空间的模板。例如，如果您想要预览您已经保存为“{{ns:User}}:Foo/{{int:templatesandbox-suffix}}/{{ns:Template}}:Test”的{{ns:Template}}:Test的版本，请使用“{{ns:User}}:Foo/{{int:templatesandbox-suffix}}”作为前缀。',
